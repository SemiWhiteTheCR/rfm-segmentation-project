...
В проекте рассчитаны метрики **Recency**, **Frequency** и **Monetary** на основе e-commerce датасета с 100 пользователями и 367 заказами. Построены сегменты (VIP, Loyal, Promising, Regular, Low Activity, At Risk, Lost) и проанализирован их вклад в выручку и риск оттока.
